...
function createOEMCA() {
  infoln "Enrolling the OEM CA admin"
  ...
  infoln "Registering OEM org admin"
  set -x
  ...
  infoln "Generating OEM peer0 msp"
  set -x
  ...
  infoln "Generating the OEM peer-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  ...
  infoln "Generating OEM user msp"
  set -x
  ...
  infoln "Generating OEM org admin msp"
  set -x
