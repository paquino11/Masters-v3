...
async function main(): Promise<void> {
    ...
    try {
        ...
        //await BatchRegistration(contract, "hello")
        // Return all the current assets on the ledger.
        //await getAllAssets(contract);
        /*
        await getAllAriesAgent(contract);
        await getAllDeviceModels(contract);
        await getAllDevices(contract);
        await getAllBatchs(contract);

        await AgentRegistration(contract);
        await getAllAriesAgent(contract);
        await DeviceGenesisRegistration(contract);
        await getAllDevices(contract);
        await BuyDevice(contract);
        await getAllDevices(contract);
        await ClaimDevice(contract);
        await getAllDevices(contract);
        await TwinDevice(contract);
        await getAllDevices(contract);
        await UntwinDevice(contract);
        await getAllDevices(contract);
        await SellDevice(contract);
        await getAllDevices(contract);
        */
