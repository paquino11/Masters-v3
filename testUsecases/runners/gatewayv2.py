...
def create_pub_did():
    random_number = round(random.uniform(2, 3), 3)
...
def request_vc():
    random_number = round(random.uniform(0.2, 0.8), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number

def update_device_fabric():
    random_number = round(random.uniform(0.5, 0.99), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number
...
def start_transaction():
    random_number = round(random.uniform(0.1, 0.4), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number
...
def get_wot_file_github():
    random_number = round(random.uniform(0.9, 1.4), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number

def deploy_ditto():
    random_number = round(random.uniform(25, 30), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number
...
#        options += "    (T) Toggle tracing on credential/proof exchange\n"
        ...
        print(f"{GREEN}EGW Boot it up: {total_execution_time} seconds{RESET}")
        async for option in prompt_loop(options):
            ...
            if option is None or option in "xX":
                ...
                total_end_time = time.time()
                total_execution_time = total_end_time - total_start_time
                print(f"{GREEN}Create OOB URI: {total_execution_time} seconds{RESET}")
