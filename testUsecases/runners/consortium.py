...
def admin_api_oob():
    random_number = round(random.uniform(0.2, 0.5), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number

def create_uuid_and_store():
    random_number = round(random.uniform(0.3, 0.7), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number

def oob_with_goalcode():
    random_number = round(random.uniform(0.2, 0.5), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number
...
def propose_vc():
    random_number = round(random.uniform(0.4, 0.99), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number

def create_send_fabric_cred():
    random_number = round(random.uniform(2, 2.7), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number

def send_vc():
    random_number = round(random.uniform(1.5, 2.5), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number

def generate_device_model_id():
    random_number = round(random.uniform(0.1, 0.99), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number

def add_wot_github():
    random_number = round(random.uniform(0.4, 0.6), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number
...
def reg_oem_pub_did():
    random_number = round(random.uniform(0.1, 0.7), 3)
    time.sleep(random_number)
    print(f"{GREEN}\t{random_number}\n{RESET}")
    return random_number
...
async def main(args):
    ...
    try:
        ...
        consortium_schema_name = "oem_schema"
        ...
        async for option in prompt_loop(options):
            ...
            if option is None or option in "xX":
                ...
                if created:
                    ...
                    await consortium_agent.create_schema_and_cred_def(
                        schema_name=consortium_schema_name,
                        schema_attrs=consortium_schema_attrs,
                    )
            ...
            elif option == "1": #issue credential
                consortium_agent.agent.connection_id = await prompt("Enter connection ID: ")
            ...
            elif option == "2a": #Request * Connectionless *
            ...
            elif option == "3a": #get connections
                response = await consortium_agent.agent.admin_GET(f"/connections")
                print(response)

            elif option == "4": #create a new invitation
                log_msg(
            ...
            elif option == "5" and consortium_agent.revocation: #revocation
            ...
            elif option == "6" and consortium_agent.revocation: #revocation
                try:
